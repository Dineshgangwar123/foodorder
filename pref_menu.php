...
?>
    ...
    <section class="product-shop spad">
        <div class="container">
            <a href="menu.php"><h3 align="center" style="background-color: white">Check All foods</h3></a>
                ...
                <div class="col-lg-12 order-1 order-lg-2"> 
                    <div class="product-list">
                        <div class="row">
                            ...
                            $result = mysqli_query($link,"SELECT * FROM `menuitem` where  activate_status=1 and category ='" .$pref. "' " );
